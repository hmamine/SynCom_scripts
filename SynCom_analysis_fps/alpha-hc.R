#R scripts to reproduce alpha diversity analyses used in Hassani et al., (example of FlowPots)
...
#***subset samples to full community and highly competitive depleted samples***
...
#preparing Shannon index and Observed species alpha diversity plots
